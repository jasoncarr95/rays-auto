...
!(function ($) {
  ...
  function gn_getItemsNextFilter(t, e, s, i, o) {
    for (var n = 0, r = 0, c = i, a = t.length - 1; a >= c; c++) {
      if ((r++, r >= a)) return r;
      var f = t.eq(c);
      if (f.is(e) && (n++, n == s)) return r;
      c == a && (c = -1);
    }
  }
  ...
  function in_getResponsiveValues(t, e, s) {
    ...
    return (
      (t.items.visible = i), (t.items[t.d.width] = o), (t[t.d.width] = i * o), t
    );
  }
  ...
  function is_undefined(t) {
    return (
      is_null(t) || "undefined" == typeof t || "" === t || "undefined" === t
    );
  }
  function is_array(t) {
        ...
        (FN._init = function (t, e, s) {
          ...
          (FN._bind_events = function () {
            FN._unbind_events(),
              ...
              $cfs.bind(cf_e("ql_set_page_nr", conf), function (t, e) {
                (itms.first = itms.first + parseInt(e, 10)),
                  itms.first > itms.total && (itms.first = parseInt(e, 10));
              }),
              ...
              $cfs.bind(cf_e("slide_next", conf), function (t, e, s) {
                ...
                if (
                  ...
                  for (
                    ...
                    opts.items.visible - s >= r && s < itms.total;
              ...
              $cfs.bind(cf_e("removeItem", conf), function (t, e, s, i) {
                ...
                if (e instanceof $ && e.length > 1)
                  return (
                    (c = $()),
                    e.each(function (t, e) {
                      var o = $cfs.trigger(cf_e("removeItem", conf), [
                        $(this),
                        s,
                        i,
                      ]);
                    ...
                    (opts.pagination.anchorBuilder &&
                      ...
                      opts.pagination.container.each(function () {
                        for (var t = 0; o > t; t++) {
                          var e = $cfs
                            .children()
                            .eq(gn_getItemIndex(t * i, 0, !0, itms, $cfs));
                          $(this).append(
              ...
              $cfs.bind(cf_e("updateSizes", conf), function (t) {
                ...
                if (
                  ...
                  opts.responsive
                    ? ((opts.items.width = opts.items.sizesConf.width),
                      ...
                      (opts = in_getResponsiveValues(opts, s, i)),
                      (e = opts.items.visible),
                      sz_setResponsiveSizes(opts, s))
                    : opts.items.visibleConf.variable
                    ? (e = gn_getVisibleItemsNext(s, opts, 0))
                    : "*" != opts.items.filter &&
                      (e = gn_getVisibleItemsNextFilter(s, opts, 0)),
                  !opts.circular && 0 != itms.first && e > itms.first)
                ) {
                  if (opts.items.visibleConf.variable)
                    var o =
                      gn_getVisibleItemsPrev(s, opts, itms.first) - itms.first;
                  else if ("*" != opts.items.filter)
                    var o =
                      gn_getVisibleItemsPrevFilter(s, opts, itms.first) -
                      itms.first;
                  else var o = opts.items.visible - itms.first;
                  debug(
                    conf,
                    "Preventing non-circular: sliding " + o + " items backward."
                  ),
                ...
                return (
                  $cfs.trigger(cf_e("updatePageStatus", conf), [!0, n]),

...
!(function (t) {
  ...
  (D.cleanData =
    ...
    (D.widget = function (t, i, e) {
      ...
      return (
        ...
        ((n = new i()).options = D.widget.extend({}, n.options)),
        ...
        (a.prototype = D.widget.extend(
          n,
          { widgetEventPrefix: (s && n.widgetEventPrefix) || t },
          r,
          { constructor: a, namespace: o, widgetName: t, widgetFullName: h }
        )),
        s
          ? (D.each(s._childConstructors, function (t, e) {
              var i = e.prototype;
              D.widget(i.namespace + "." + i.widgetName, a, e._proto);
            }),
    ...
    (D.widget.extend = function (t) {
      for (var e, i, s = o.call(arguments, 1), a = 0, n = s.length; a < n; a++)
        for (e in s[a])
          (i = s[a][e]),
            s[a].hasOwnProperty(e) &&
              void 0 !== i &&
              (D.isPlainObject(i)
                  ...
                  return "instance" === i
                    ...
                    ? D.isFunction(e[i]) && "_" !== i.charAt(0)
                      ? (t = e[i].apply(e, s)) !== e && void 0 !== t
                        ? ((a = t && t.jquery ? a.pushStack(t.get()) : t), !1)
                        : void 0
                      : D.error(
                          "no such method '" +
                            i +
    ...
    (D.Widget.prototype = {
      ...
      option: function (t, e) {
        ...
        if ("string" == typeof t)
          if (((n = {}), (t = (i = t.split(".")).shift()), i.length)) {
            for (
              s = n[t] = D.widget.extend({}, this.options[t]), a = 0;
              a < i.length - 1;
              a++
            )
              (s[i[a]] = s[i[a]] || {}), (s = s[i[a]]);
        ...
        function t(t, e) {
          for (var i, s = 0; s < t.length; s++)
            (i = r.classesElementLookup[t[s]] || D()),
              (i = a.add
                ? D(D.unique(i.get().concat(a.element.get())))
                : D(i.not(a.element).get())),
              (r.classesElementLookup[t[s]] = i),
              n.push(t[s]),
              e && a.classes[t[s]] && n.push(a.classes[t[s]]);
        }
        return (
          (a = D.extend(
          ...
          a.keys && t(a.keys.match(/\S+/g) || [], !0),
          a.extra && t(a.extra.match(/\S+/g) || []),
          n.join(" ")
        );
      },
      ...
      _on: function (a, n, t) {
        var r,
          o = this;
        "boolean" != typeof a && ((t = n), (n = a), (a = !1)),
          t
            ? ((n = r = D(n)), (this.bindings = this.bindings.add(n)))
    ...
    D.each({ show: "fadeIn", hide: "fadeOut" }, function (n, r) {
      D.Widget.prototype["_" + n] = function (e, t, i) {
        var s;
        "string" == typeof t && (t = { effect: t });
        var a = t ? (!0 !== t && "number" != typeof t && t.effect) || r : n;
        "number" == typeof (t = t || {}) && (t = { duration: t }),
          (s = !D.isEmptyObject(t)),
          (t.complete = i),
          t.delay && e.delay(t.delay),
          s && D.effects && D.effects.effect[a]
            ? e[n](t)
            : a !== n && e[a]
            ? e[a](t.duration, t.easing, i)
            : e.queue(function (t) {
                D(this)[n](), i && i.call(e[0]), t();
              });
      };
    });
  var s, w, x, n, r, h, l, u, C;
  D.widget;
  function M(t, e, i) {
    return [
    ...
    (D.position = {
        ...
        return {
          width:
            ...
            ("auto" === i && t.height < t.element[0].scrollHeight)
              ...
              : 0,
          height: e ? D.position.scrollbarWidth() : 0,
        };
      },
      getWithinInfo: function (t) {
        ...
        return {
          ...
          isWindow: i,
          isDocument: s,
          offset: !i && !s ? D(t).offset() : { left: 0, top: 0 },
      ...
      return (
        ...
        this.each(function () {
          var i,
            ...
            e = I(this, "marginLeft"),
            s = I(this, "marginTop"),
            a = o + e + I(this, "marginRight") + b.width,
            n = h + s + I(this, "marginBottom") + b.height,
            l = D.extend({}, m),
            u = M(k.my, r.outerWidth(), r.outerHeight());
          "right" === c.my[0]
            ? (l.left -= o)
            : "center" === c.my[0] && (l.left -= o / 2),
            "bottom" === c.my[1]
              ? (l.top -= h)
              : "center" === c.my[1] && (l.top -= h / 2),
            (l.left += u[0]),
            (l.top += u[1]),
            ...
            c.using &&
              (t = function (t) {
                ...
                p < o && x(e + i) < p && (n.horizontal = "center"),
                  f < h && x(s + a) < f && (n.vertical = "middle"),
                  w(x(e), x(i)) > w(x(s), x(a))
                    ? (n.important = "horizontal")
                    : (n.important = "vertical"),
                  c.using.call(this, t, n);
              }),
            r.offset(D.extend(l, { using: t }));
        })
      );
    }),
    (D.ui.position = {
      fit: {
        left: function (t, e) {
          var i = e.within,
            ...
            r = s - n,
            o = n + e.collisionWidth - a - s;
          e.collisionWidth > a
            ? 0 < r && o <= 0
              ? ((i = t.left + r + e.collisionWidth - a - s), (t.left += r - i))
              : (t.left =
                  !(0 < o && r <= 0) && o < r ? s + a - e.collisionWidth : s)
            : 0 < r
            ? (t.left += r)
            : 0 < o
            ? (t.left -= o)
        ...
        top: function (t, e) {
          var i = e.within,
            ...
            r = s - n,
            o = n + e.collisionHeight - a - s;
          e.collisionHeight > a
            ? 0 < r && o <= 0
              ? ((i = t.top + r + e.collisionHeight - a - s), (t.top += r - i))
              : (t.top =
                  !(0 < o && r <= 0) && o < r ? s + a - e.collisionHeight : s)
            : 0 < r
            ? (t.top += r)
            : 0 < o
            ? (t.top -= o)
      ...
      flip: {
        left: function (t, e) {
          var i = e.within,
            ...
            r = -2 * e.offset[0];
          o < 0
            ? ((s = t.left + l + i + r + e.collisionWidth - a - s) < 0 ||
                s < x(o)) &&
              (t.left += l + i + r)
            : 0 < h &&
              (0 <
        ...
        top: function (t, e) {
          var i = e.within,
            ...
            r = -2 * e.offset[1];
          o < 0
            ? ((s = t.top + l + i + r + e.collisionHeight - a - s) < 0 ||
                s < x(o)) &&
              (t.top += l + i + r)
            : 0 < h &&
              (0 <
  ...
  D.ui.position,
      ...
      return this[0].labels && this[0].labels.length
        ...
        : ((e = this.eq(0).parents("label")),
          (t = this.attr("id")) &&
            ...
            (t = "label[for='" + D.ui.escapeSelector(t) + "']"),
    ...
    D.widget("ui.accordion", {
      ...
      _panelKeyDown: function (t) {
        t.keyCode === D.ui.keyCode.UP &&
          t.ctrlKey &&
          D(t.currentTarget).prev().trigger("focus");
      },
      refresh: function () {
        var t = this.options;
        this._processPanels(),
          (!1 === t.active && !0 === t.collapsible) || !this.headers.length
            ? ((t.active = !1), (this.active = D()))
            : !1 === t.active
            ? this._activate(0)
      ...
      _eventHandler: function (t) {
        ...
        t.preventDefault(),
          (a && !e.collapsible) ||
            ...
            ((e.active = !n && this.headers.index(s)),
            (this.active = a ? D() : s),
            this._toggle(r),
            this._removeClass(
              i,
            ...
            a ||
              ...
              e.icons &&
                ((a = s.children(".ui-accordion-header-icon")),
                this._removeClass(a, null, e.icons.header)._addClass(
                  a,
                  null,
              ...
              ? ((s = t.show().outerHeight()),
                ...
                void t.hide().animate(this.showProps, {
                  ...
                  step: function (t, e) {
                    (e.now = Math.round(t)),
                      "height" !== e.prop
                        ? "content-box" === h && (o += e.now)
                        : "content" !== r.options.heightStyle &&
                          ((e.now = Math.round(s - i.outerHeight() - o)),
                          (o = 0));
                  },
                }))
              : i.animate(this.hideProps, n, a, l)
            : t.animate(this.showProps, n, a, l)
        );
      },
  ...
  D.extend(D.ui, { datepicker: { version: "1.12.1" } }),
    D.extend(d.prototype, {
      ...
      _attachDatepicker: function (t, e) {
        ...
        t.id || ((this.uuid += 1), (t.id = "dp" + this.uuid)),
          ((i = this._newInst(D(t), a)).settings = D.extend({}, e || {})),
          "input" === s
            ? this._connectDatepicker(t, i)
            : a && this._inlineDatepicker(t, i);
      },
            ...
            (e.trigger = D(
              this._get(e, "buttonImageOnly")
                ...
                : D("<button type='button'></button>")
                    .addClass(this._triggerClass)
                    .html(
                      i ? D("<img/>").attr({ src: i, alt: s, title: s }) : s
                    )
            )),
      ...
      _dialogDatepicker: function (t, e, i, s, a) {
        ...
        return (
          r ||
            ...
            D.data(this._dialogInput[0], "datepicker", r)),
          g(r.settings, s || {}),
      ...
      _doKeyDown: function (t) {
        ...
        if (((s._keyEvent = !0), D.datepicker._datepickerShowing))
          switch (t.keyCode) {
            case 9:
              D.datepicker._hideDatepicker(), (a = !1);
              break;
            case 13:
              return (
                (i = D(
                ...
                (e = D.datepicker._get(s, "onSelect"))
                  ? ((i = D.datepicker._formatDate(s)),
            ...
            case 33:
              D.datepicker._adjustDate(
                t.target,
                t.ctrlKey
                  ? -D.datepicker._get(s, "stepBigMonths")
                  : -D.datepicker._get(s, "stepMonths"),
                "M"
              );
              break;
            case 34:
            ...
            case 37:
              (t.ctrlKey || t.metaKey) &&
                D.datepicker._adjustDate(t.target, n ? 1 : -1, "D"),
                (a = t.ctrlKey || t.metaKey),
      ...
      _doKeyPress: function (t) {
        var e,
          i = D.datepicker._getInst(t.target);
        if (D.datepicker._get(i, "constrainInput"))
          return (
            (e = D.datepicker._possibleChars(
              D.datepicker._get(i, "dateFormat")
            )),
        ...
        "input" !== (t = t.target || t).nodeName.toLowerCase() &&
          ...
          D.datepicker._isDisabledDatepicker(t) ||
            ...
            !1 !==
              ...
              (s = { left: D.datepicker._pos[0], top: D.datepicker._pos[1] }),
              ...
              (s = D.datepicker._checkOffset(a, s, e)),
              a.dpDiv.css({
                position:
              ...
              a.inline ||
                ((i = D.datepicker._get(a, "showAnim")),
                (s = D.datepicker._get(a, "duration")),
                a.dpDiv.css(
                  "z-index",
                  (function (t) {
                ...
                D.effects && D.effects.effect[i]
                  ? a.dpDiv.show(i, D.datepicker._get(a, "showOptions"), s)
                  : a.dpDiv[i || "show"](i ? s : null),
      ...
      _checkOffset: function (t, e, i) {
        ...
        return (
          (e.left -= this._get(t, "isRTL") ? s - n : 0),
          (e.left -=
          ...
          (e.left -= Math.min(
            e.left,
            e.left + s > o && s < o ? Math.abs(e.left + s - o) : 0
          )),
          (e.top -= Math.min(
            e.top,
            e.top + a > h && a < h ? Math.abs(a + r) : 0
          )),
          e
        );
      },
      ...
      _hideDatepicker: function (t) {
        var e,
          ...
          s = this._curInst;
        !s ||
          (t && s !== D.data(t, "datepicker")) ||
          (this._datepickerShowing &&
            ((e = this._get(s, "showAnim")),
            (i = this._get(s, "duration")),
            (t = function () {
              D.datepicker._tidyDialog(s);
            }),
            D.effects && (D.effects.effect[e] || D.effects[e])
              ? s.dpDiv.hide(e, D.datepicker._get(s, "showOptions"), i, t)
              : s.dpDiv[
                  "slideDown" === e
                    ? "slideUp"
                    : "fadeIn" === e
      ...
      parseDate: function (e, a, t) {
        ...
        function s(t, e, i) {
          ...
          if (
            (D.each(e, function (t, e) {
              var i = e[1];
              if (a.substr(u, i.length).toLowerCase() === i.toLowerCase())
        ...
        if (u < a.length && ((h = a.substr(u)), !/^\s+/.test(h)))
      ...
      _possibleChars: function (e) {
        ...
        for (var i = "", s = !1, a = 0; a < e.length; a++)
          if (s) "'" !== e.charAt(a) || t("'") ? (i += e.charAt(a)) : (s = !1);
          else
            switch (e.charAt(a)) {
              case "d":
              case "m":
              ...
              ? (function (t) {
                  try {
                    return D.datepicker.parseDate(
                      D.datepicker._get(o, "dateFormat"),
                      t,
                      D.datepicker._getFormatConfig(o)
                    );
                  } catch (t) {}
                  for (
                    var e =
                        (t.toLowerCase().match(/^c/)
                          ? D.datepicker._getDate(o)
                          : null) || new Date(),
                      i = e.getFullYear(),
                      s = e.getMonth(),
                      a = e.getDate(),
                    ...
                    switch (r[2] || "d") {
                      ...
                      case "M":
                        (s += parseInt(r[1], 10)),
                          (a = Math.min(a, D.datepicker._getDaysInMonth(i, s)));
                        break;
                      case "y":
                      case "Y":
                        (i += parseInt(r[1], 10)),
      ...
      _setDate: function (t, e, i) {
        ...
        (t.selectedDay = t.currentDay = e.getDate()),
          ...
          (a === t.selectedMonth && n === t.selectedYear) ||
            i ||
            this._notifyChange(t),
          this._adjustInstDate(t),
        ...
        if ((U < 0 && ((U += 12), V--), q))
          for (
            e = this._daylightSavingAdjust(
              new Date(
                q.getFullYear(),
                q.getMonth() - Y[0] * Y[1] + 1,
                q.getDate()
              )
            ),
              e = j && e < j ? j : e;
            this._daylightSavingAdjust(new Date(V, U, 1)) > e;
        ...
        for (
          t.drawMonth = U,
            ...
            K = H
              ...
              : K,
            i = this._canAdjustMonth(t, -1, V, U)
            ...
            K = H
              ...
              : K,
            s = this._canAdjustMonth(t, 1, V, U)
            ...
            K = this._get(t, "gotoCurrent") && t.currentDay ? L : E,
            W = H ? this.formatDate(W, K, this._getFormatConfig(t)) : W,
            H = t.inline
              ? ""
          ...
          for (_ = "", this.maxRows = 4, v = 0; v < Y[1]; v++) {
            if (
              ((b = this._daylightSavingAdjust(new Date(V, U, t.selectedDay))),
              (w = " ui-corner-all"),
              (y = ""),
              R)
            ) {
              if (((y += "<div class='ui-datepicker-group"), 1 < Y[1]))
                switch (v) {
                  case 0:
                  ...
                  case Y[1] - 1:
                    ...
                    break;
                  default:
                    (y += " ui-datepicker-group-middle"), (w = "");
                }
              y += "'>";
            }
            for (
              y +=
                ...
                w +
                "'>" +
                (/all|left/.test(w) && 0 === m ? (F ? s : i) : "") +
                (/all|right/.test(w) && 0 === m ? (F ? i : s) : "") +
            ...
            for (
              y += k + "</tr></thead><tbody>",
                x = this._getDaysInMonth(V, U),
                V === t.selectedYear &&
                  U === t.selectedMonth &&
                  (t.selectedDay = Math.min(t.selectedDay, x)),
                w = (this._getFirstDayOfMonth(V, U) - a + 7) % 7,
                x = Math.ceil((w + x) / 7),
                C = R && this.maxRows > x ? this.maxRows : x,
                this.maxRows = C,
                M = this._daylightSavingAdjust(new Date(V, U, 1 - w)),
                I = 0;
              I < C;
              I++
            ) {
              for (
                ...
                (A = u ? u.apply(t.input ? t.input[0] : null, [M]) : [!0, ""]),
                  (N =
                    ((S = M.getMonth() !== U) && !d) ||
                    !A[0] ||
                    (j && M < j) ||
                  ...
                  (T +=
                    ...
                    ((M.getTime() === b.getTime() &&
                      U === t.selectedMonth &&
                      t._keyEvent) ||
                    (p.getTime() === M.getTime() && p.getTime() === b.getTime())
                      ? " " + this._dayOverClass
                      : "") +
                    (N
      ...
      _generateMonthYearHeader: function (t, e, i, s, a, n, r, o) {
        var h,
          l,
          u,
          c,
      ...
      _adjustInstDate: function (t, e, i) {
        var s = t.selectedYear + ("Y" === i ? e : 0),
          ...
          e =
            Math.min(t.selectedDay, this._getDaysInMonth(s, a)) +
            ("D" === i ? e : 0),
          e = this._restrictMinMax(
            t,
            this._daylightSavingAdjust(new Date(s, a, e))
          );
  ...
  D.datepicker,
    ...
    D.widget("ui.menu", {
        ...
        (this.activeMenu = this.element),
          ...
          this._on({
            ...
            "mouseenter .ui-menu-item": function (t) {
              var e, i;
              this.previousFilter ||
                ((e = D(t.target).closest(".ui-menu-item")),
                (i = D(t.currentTarget)),
                e[0] === i[0] &&
                  (this._removeClass(
        ...
        this._toggleClass(
          ...
          (e = i
            ...
            .each(function () {
              ...
              s._addClass(i, "ui-menu-icon", "ui-icon " + a),
      ...
      _scrollIntoView: function (t) {
        var e, i, s;
        this._hasScroll() &&
          ((i = parseFloat(D.css(this.activeMenu[0], "borderTopWidth")) || 0),
          (s = parseFloat(D.css(this.activeMenu[0], "paddingTop")) || 0),
      ...
      _open: function (t) {
        var e = D.extend({ of: this.active }, this.options.position);
        clearTimeout(this.timer),
          this.element
            .find(".ui-menu")
  ...
  D.widget("ui.mouse", {
      ...
      D.ui.formResetMixin,
      {
        ...
        _position: function () {
          this.menuWrap.position(
            D.extend({ of: this.button }, this.options.position)
          );
        },
        close: function (t) {
          this.isOpen &&
        ...
        _renderItem: function (t, e) {
          var i = D("<li>"),
            s = D("<div>", { title: e.element.attr("title") });
          return (
    ...
    D.widget("ui.slider", D.ui.mouse, {
      ...
      _createHandles: function () {
        ...
        (this.handles = i.add(D(s.join("")).appendTo(this.element))),
          this._addClass(this.handles, "ui-slider-handle", "ui-state-default"),
          (this.handle = this.handles.eq(0)),
          this.handles.each(function (t) {
            D(this).data("ui-slider-handle-index", t).attr("tabIndex", 0);
          });
      },
          ...
          ? (!0 === t.range &&
              (t.values
                ? t.values.length && 2 !== t.values.length
                  ...
                  : D.isArray(t.values) && (t.values = t.values.slice(0))
      ...
      _mouseCapture: function (t) {
        ...
        return (
          ...
          this.handles.each(function (t) {
            ...
            (e < s ||
              (s === e &&
                (t === o._lastChangedValue || o.values(t) === h.min))) &&
              ((s = e), (a = D(this)), (n = t));
          }),
          !1 !== this._start(t, n) &&
            ...
            a.trigger("focus"),
            (e = a.offset()),
            (r = !D(t.target).parents().addBack().is(".ui-slider-handle")),
            (this._clickOffset = r
              ? { left: 0, top: 0 }
              : {
                  left: t.pageX - e.left - a.width() / 2,
                  top:
                    t.pageY -
                    e.top -
                    a.height() / 2 -
            ...
            this.handles.hasClass("ui-state-hover") || this._slide(t, n, i),
            (this._animateOff = !0)))
        );
      },
      _mouseStart: function () {
      ...
      values: function (t, e) {
        ...
        for (i = this.options.values, s = t, a = 0; a < i.length; a += 1)
          ...
          ("range" === t &&
            ...
            ("min" === e
              ...
              : "max" === e &&
                ...
                (this.options.values = null))),
          D.isArray(this.options.values) && (s = this.options.values.length),
          this._super(t, e),
          t)
        ) {
          case "orientation":
      ...
      _refreshValue: function () {
        ...
        this._hasMultipleValues()
          ? this.handles.each(function (t) {
              (i =
                ((o.values(t) - o._valueMin()) /
                  (o._valueMax() - o._valueMin())) *
                100),
                (l["horizontal" === o.orientation ? "left" : "bottom"] =
                  i + "%"),
                D(this).stop(1, 1)[h ? "animate" : "css"](l, r.animate),
                !0 === o.options.range &&
          ...
          : ((t = this.value()),
            ...
            (l["horizontal" === this.orientation ? "left" : "bottom"] =
              i + "%"),
            this.handle.stop(1, 1)[h ? "animate" : "css"](l, r.animate),
            "min" === n &&
              "horizontal" === this.orientation &&
              this.range
                .stop(1, 1)
      ...
      _handleEvents: {
        keydown: function (t) {
          var e,
            i,
            s,
            a = D(t.target).data("ui-slider-handle-index");
          switch (t.keyCode) {
            case D.ui.keyCode.HOME:
            case D.ui.keyCode.END:
            case D.ui.keyCode.PAGE_UP:
            ...
            case D.ui.keyCode.LEFT:
              if (
                ...
                !this._keySliding &&
                  ((this._keySliding = !0),
                  this._addClass(D(t.target), null, "ui-state-active"),
                  !1 === this._start(t, a)))
              )
                return;
          }
          switch (
            ((s = this.options.step),
            (e = i = this._hasMultipleValues() ? this.values(a) : this.value()),
            t.keyCode)
          ) {
            case D.ui.keyCode.HOME:
              i = this._valueMin();
        ...
        keyup: function (t) {
          ...
          this._keySliding &&
            ...
            this._stop(t, e),
            this._change(t, e),
            this._removeClass(D(t.target), null, "ui-state-active"));
        },
      },
    });
  D.widget("ui.tabs", {
    ...
    _create: function () {
      ...
      (this.running = !1),
        ...
        D.isArray(t.disabled) &&
          (t.disabled = D.unique(
            t.disabled.concat(
              D.map(this.tabs.filter(".ui-state-disabled"), function (t) {
        ...
        null === i &&
          (s &&
            this.tabs.each(function (t, e) {
              if (D(e).attr("aria-controls") === s) return (i = t), !1;
            }),
          null === i &&
    ...
    _tabKeydown: function (t) {
      var e = D(D.ui.safeActiveElement(this.document[0])).closest("li"),
        i = this.tabs.index(e),
        s = !0;
    ...
    _handlePageNav: function (t) {
      return t.altKey && t.keyCode === D.ui.keyCode.PAGE_UP
        ? (this._activate(this._focusNextTab(this.options.active - 1, !1)), !0)
        : t.altKey && t.keyCode === D.ui.keyCode.PAGE_DOWN
    ...
    refresh: function () {
      ...
      (t.disabled = D.map(e.filter(".ui-state-disabled"), function (t) {
        ...
        !1 !== t.active && this.anchors.length
          ? this.active.length && !D.contains(this.tablist[0], this.active[0])
      ...
      (this.tablist = this._getList().attr("role", "tablist")),
        ...
        this.anchors.each(function (t, e) {
          var i,
            s,
            a,
            n = D(e).uniqueId().attr("id"),
            r = D(e).closest("li"),
            o = r.attr("aria-controls");
          h._isLocal(e)
            ? ((a = (i = e.hash).substring(1)),
              (s = h.element.find(h._sanitizeSelector(i))))
            : ((i =
                "#" + (a = r.attr("aria-controls") || D({}).uniqueId()[0].id)),
              (s = h.element.find(i)).length ||
                (s = h._createPanel(a)).insertAfter(
                  h.panels[t - 1] || h.tablist
                ),
              s.attr("aria-live", "polite")),
            s.length && (h.panels = h.panels.add(s)),
            o && r.data("ui-tabs-aria-controls", o),
            r.attr({ "aria-controls": a, "aria-labelledby": n }),
    ...
    _createPanel: function (t) {
      return D("<div>").attr("id", t).data("ui-tabs-destroy", !0);
    },
    _setOptionDisabled: function (t) {
      var e, i;
      for (
    ...
    _eventHandler: function (t) {
      var e = this.options,
        i = this.active,
        s = D(t.currentTarget).closest("li"),
        a = s[0] === i[0],
        n = a && e.collapsible,
        r = n ? D() : this._getPanelForTab(s),
        o = i.length ? this._getPanelForTab(i) : D(),
        i = { oldTab: i, oldPanel: o, newTab: n ? D() : s, newPanel: r };
      t.preventDefault(),
      ...
      return (
        "string" == typeof t &&
          (t = this.anchors.index(
            this.anchors.filter("[href$='" + D.ui.escapeSelector(t) + "']")
          )),
        t
      );
    },
    ...
    disable: function (t) {
      ...
      if (!0 !== e) {
        if (void 0 === t) e = !0;
          ...
          if (((t = this._getIndex(t)), -1 !== D.inArray(t, e))) return;
    ...
    load: function (t, s) {
      ...
      var n = this,
        ...
        o = { tab: i, panel: r };
      this._isLocal(t[0]) ||
        ((this.xhr = D.ajax(this._ajaxSettings(t, s, o))),
        this.xhr &&
          ...
          this.xhr
            .done(function (t, e, i) {
              setTimeout(function () {
                r.html(t), n._trigger("load", s, o), a(i, e);
              }, 1);
            })
            .fail(function (t, e) {
              setTimeout(function () {
      ...
      return {
        ...
        beforeSend: function (t, e) {
          return a._trigger(
            "beforeLoad",
            i,
            D.extend({ jqXHR: t, ajaxSettings: e }, s)
          );
        },
      };
    },
    _getPanelForTab: function (t) {
      t = D(t).attr("aria-controls");
